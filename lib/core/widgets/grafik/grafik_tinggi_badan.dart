import 'package:eimunisasi_nakes/core/widgets/grafik/line_data_tinggi_badan_boy.dart';
import 'package:eimunisasi_nakes/core/widgets/grafik/line_data_tinggi_badan_girl.dart';
...
class _LineChart extends StatelessWidget {
  ...
  LineChartBarData get lineChartBarData_1 => LineChartBarData(
        ...
        spots: (isBoy ?? true)
            ? LineDataTinggiBadanBoyModel().listDataLine1()
            : LineDataTinggiBadanGirlModel().listDataLine1(),
      );
  ...
  LineChartBarData get lineChartBarData_2 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy ?? true)
            ? LineDataTinggiBadanBoyModel().listDataLine2()
            : LineDataTinggiBadanGirlModel().listDataLine2(),
      );
  ...
  LineChartBarData get lineChartBarData_3 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy ?? true)
            ? LineDataTinggiBadanBoyModel().listDataLine3()
            : LineDataTinggiBadanGirlModel().listDataLine3(),
      );
  ...
  LineChartBarData get lineChartBarData_4 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy ?? true)
            ? LineDataTinggiBadanBoyModel().listDataLine4()
            : LineDataTinggiBadanGirlModel().listDataLine4(),
      );
  ...
  LineChartBarData get lineChartBarData_5 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy ?? true)
            ? LineDataTinggiBadanBoyModel().listDataLine5()
            : LineDataTinggiBadanGirlModel().listDataLine5(),
      );
...
class GrafikTinggiBadan extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => GrafikTinggiBadanState();
}
